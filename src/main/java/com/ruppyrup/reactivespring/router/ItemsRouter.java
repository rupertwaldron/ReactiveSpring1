package com.ruppyrup.reactivespring.router;


import com.ruppyrup.reactivespring.handler.ItemsHandler;
    ...
    public RouterFunction<ServerResponse> itemsRoute(ItemsHandler itemsHandler) {
        ...
        return RouterFunctions
                ...
                .andRoute(GET(ITEM_FUNCTIONAL_END_POINT_V1 + "/{id}")
                        .and(accept(MediaType.APPLICATION_JSON)), itemsHandler::getItem)
